...
class Graph(Container):
    ...
    def forward(self, *args):
        ...
        def _mark_as_computed(name):
            ...
            for key, value_list in self._graph.items():
                if name in value_list:
                    # print("key:{}, value:{}".format(key, value_list.index(name)))
                    if name=='cls_token' and value_list.index(name)==0:
                        inputs_available[key][1] = True
        ...
        # print(type(node_to_compute[0]))
        # print(len(node_to_compute))
        # xx = 0
        # count = 0
        # for key, inputs_available_list in inputs_available.items():
        #     print("key:{}, available:{}, inputs_available_list:{}".format(key, all(inputs_available_list), inputs_available_list))
        #     if all(inputs_available_list):
        #         count = count + 1
        #         # if all(inputs_available_list) and not computed[key]:
        #         #     print(key)
        # print(count)
        # for key, value_list in self._graph.items():
        #         print("key:{}, value:{}".format(key, value_list))
        # count = 0  
        # print(len(inputs_available))
        ...
        # count = 0
        # for key, inputs_available_list in inputs_available.items():
        #     print("key:{}, inputs_available_list:{}, value_list:{}".format(key, inputs_available_list), self._graph.items())
        #     if all(inputs_available_list):
        #         count = count + 1
        #         # if all(inputs_available_list) and not computed[key]:
        #         #     print(key)
        # print(count)
        # combined_keys = inputs_available.keys() | self._graph.keys()
        # d_comb = {key: inputs_available.get(key, []) + self._graph.get(key, []) for key in combined_keys}  
        # for key, inputs_available_list in d_comb.items():
        #     print("key:{}, inputs_available_list:{}".format(key, inputs_available_list))
        # f = open (r'.\inputs_available.txt','w')
        # for key, value in inputs_available.items():
        #     print("key:{}, available:{}".format(key, value), file=f)
        # f.close()
        # raise ValueError("I am Test!!!")

        while node_to_compute is not None:
            # print(type(node_to_compute))
            # raise ValueError("I am Test!!!")
            ...
            # print("input:{}, output:{}".format(node_to_compute, output_names))
            # raise ValueError("I am Test!!!")
        ...
        # count = 0
        # for key, inputs_available_list in inputs_available.items():
        #     print("key:{}, inputs_available_list:{}, value_list:{}".format(key, inputs_available_list), self._graph.items()[key])
        #     if all(inputs_available_list):
        #         count = count + 1
        #         # if all(inputs_available_list) and not computed[key]:
        #         #     print(key)
        ...
        # f = open (r'.\value_list.txt','w')
        # for key, value in self._graph.items():
        #     print("key:{}, value_list:{}".format(key, value), file=f)
        # f.close()
    ...
    def from_onnx(attributes=None):
        ...
        for attr_name in attributes.keys():
            if attr_name == "axis" or attr_name == "axes":
                ...
                kwargs["split_size_or_sections"] = tuple(attributes[attr_name])
        return Split(**kwargs)
